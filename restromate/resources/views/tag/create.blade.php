...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Tag @if(@$offer) Update @else Create @endif</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a></li>
                    <li class="breadcrumb-item "><a href="{{route('tag')}}">Tag List</a></li>
                    @if(@$offer)
            ...
            <div class="col-md-4">
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-footer">
                        ...
                        @endif
                        <a href="{{route('tag')}}"><button type="button" class="btn btn-success">Back</button></a>
                    </div>
